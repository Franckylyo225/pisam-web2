      ...
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto">
            Nous sommes à votre écoute pour répondre à vos questions et vous accompagner dans vos démarches de santé.
          </p>
        </div>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {/* Address */}
          <div className="bg-card rounded-2xl p-6 shadow-sm border border-border/50 text-center hover:shadow-pisam-lg transition-shadow">
